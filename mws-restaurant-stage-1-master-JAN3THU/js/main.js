...
if('serviceWorker' in navigator){
  console.log('sw registered jan3thu');
  
//    navigator.serviceWorker
//    .register('../sw.js')
//    console.log('register sw on jan3thu');
  
//    window.addEventListener('load', () => {
//    navigator.serviceWorker
//    .register('../sw.js')
//    .then(reg => console.log('sw: registered on jan3thu'))
//    .catch(err => console.log('sw error on jan3thu: ${err}'));      
// });
